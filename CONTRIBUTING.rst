...
Welcome to ``ADL_SARdespeckling`` contributor's guide.
...
If you experience bugs or general issues with ``ADL_SARdespeckling``, please have a look
...
You can help improve ``ADL_SARdespeckling`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``ADL_SARdespeckling`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``ADL_SARdespeckling``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n ADL_SARdespeckling python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/ADL_SARdespeckling.git
    cd ADL_SARdespeckling
...
#. Install |pre-commit|_::
   ...
   ``ADL_SARdespeckling`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/ADL_SARdespeckling
.. _issue tracker: https://github.com/<USERNAME>/ADL_SARdespeckling/issues
.. <-- end -->
